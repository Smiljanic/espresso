...
#define __PYX_HAVE__espressomd__magnetostatic_extensions
#define __PYX_HAVE_API__espressomd__magnetostatic_extensions
#include <vector>
#include "ios"
#include "new"
#include "stdexcept"
...
static const char *__pyx_f[] = {
  "__init__.pxd",
  "espressomd/magnetostatic_extensions.pyx",
  "type.pxd",
};
...
/* Module declarations from 'espressomd.magnetostatic_extensions' */
#define __Pyx_MODULE_NAME "espressomd.magnetostatic_extensions"
int __pyx_module_is_main_espressomd__magnetostatic_extensions = 0;

/* Implementation of 'espressomd.magnetostatic_extensions' */
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initmagnetostatic_extensions(void); /*proto*/
PyMODINIT_FUNC initmagnetostatic_extensions(void)
#else
PyMODINIT_FUNC PyInit_magnetostatic_extensions(void); /*proto*/
PyMODINIT_FUNC PyInit_magnetostatic_extensions(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_magnetostatic_extensions(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("magnetostatic_extensions", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_espressomd__magnetostatic_extensions) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "espressomd.magnetostatic_extensions")) {
      if (unlikely(PyDict_SetItemString(modules, "espressomd.magnetostatic_extensions", __pyx_m) < 0)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  __pyx_t_1 = __Pyx_ImportModule("espressomd._system"); if (!__pyx_t_1) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ImportVoidPtr(__pyx_t_1, "skin_set", (void **)&__pyx_vp_10espressomd_7_system_skin_set, "bool") < 0) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "espressomd/magnetostatic_extensions.pyx":22
 * cimport utils
 ...
 * IF DIPOLES == 1:
 */
  __pyx_t_2 = PyList_New(1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_INCREF(__pyx_n_s_Actor);
  __Pyx_GIVEREF(__pyx_n_s_Actor);
  PyList_SET_ITEM(__pyx_t_2, 0, __pyx_n_s_Actor);
  __pyx_t_3 = __Pyx_Import(__pyx_n_s_actors, __pyx_t_2, -1); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_ImportFrom(__pyx_t_3, __pyx_n_s_Actor); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_Actor, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

  /* "espressomd/magnetostatic_extensions.pyx":1
 * #             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init espressomd.magnetostatic_extensions", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init espressomd.magnetostatic_extensions");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
